 ...
 * @author suyog
 */
public class ManagementAddQue extends javax.swing.JFrame {

    /**
     * Creates new form ManagementAddQue
     */
    public ManagementAddQue() {
        initComponents();
        try
        {
         Connection conn = DatabaseConnection.connection();
         Statement stmt = conn.createStatement();
         ResultSet rs = stmt.executeQuery("SELECT count(id) from MANAGEMENT");
    ...
    private void initComponents() {
        ...
        jPanel2.add(jLabel15, new org.netbeans.lib.awtextra.AbsoluteConstraints(430, 90, -1, -1));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try{
            ...
            setVisible(false);
            new ManagementAddQue().setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ManagementAddQue.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
