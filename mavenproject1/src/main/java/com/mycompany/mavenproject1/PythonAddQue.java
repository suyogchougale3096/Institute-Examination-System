 ...
 * @author suyog
 */
public class PythonAddQue extends javax.swing.JFrame {
    ...
    public PythonAddQue() {
        ...
        try
        {
         ...
         ResultSet rs = stmt.executeQuery("SELECT count(id) from PYTHON");
    ...
    private void initComponents() {
        ...
        jPanel2.add(jLabel15, new org.netbeans.lib.awtextra.AbsoluteConstraints(450, 80, -1, -1));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try{
            ...
            setVisible(false);
            new PythonAddQue().setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PythonAddQue.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
