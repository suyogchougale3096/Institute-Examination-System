 ...
 * @author suyog
 */
public class ManagementExamPage extends javax.swing.JFrame {
...
public void question()
{
        try{
         Connection conn = DatabaseConnection.connection();
         Statement stmt = conn.createStatement();
         ResultSet rs1 = stmt.executeQuery("SELECT * FROM MANAGEMENT WHERE id = '"+questionId+"'");
         while(rs1.next())
         {
...
public void submit()
{
 ...
 try{
     Connection conn = DatabaseConnection.connection();
     Statement stmt = conn.createStatement();
     stmt.executeUpdate("UPDATE SAMPLE1 SET management = '"+marks+"' WHERE Enrollment_No = '"+EnrollmentNo+"'");
     String marks1 = String.valueOf(marks);
...
Timer time;
    ...
    /**
     * Creates new form ManagementExamPage
     */
    public ManagementExamPage() {
        initComponents();
    }

    ManagementExamPage(int EnrollmentNo) {
        initComponents();
        jRadioButton5.setVisible(false);
    ...
    private void initComponents() {
        ...
        jPanel1.add(jRadioButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(420, 310, 93, -1));
        ...
        jPanel1.add(jRadioButton2, new org.netbeans.lib.awtextra.AbsoluteConstraints(420, 350, 93, -1));
        ...
        jPanel1.add(jRadioButton3, new org.netbeans.lib.awtextra.AbsoluteConstraints(420, 390, 93, -1));
        ...
        jPanel1.add(jRadioButton4, new org.netbeans.lib.awtextra.AbsoluteConstraints(420, 430, 93, -1));
        ...
        jPanel1.add(jRadioButton5, new org.netbeans.lib.awtextra.AbsoluteConstraints(510, 550, -1, -1));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ManagementExamPage.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ManagementExamPage().setVisible(true);
            }
        });
    }
