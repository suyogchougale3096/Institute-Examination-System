 ...
 * @author suyog
 */
public class ETEAddQue extends javax.swing.JFrame {

    /**
     * Creates new form ETEAddQue
     */
    public ETEAddQue() {
        initComponents();
        try
        {
         ...
         ResultSet rs = stmt.executeQuery("SELECT count(id) from ETE");
    ...
    private void initComponents() {
        ...
        jLabel15.setText("Emerging Trends in Computer and Information Technology");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try{
            Connection conn = DatabaseConnection.connection();
            PreparedStatement ps = conn.prepareStatement("INSERT INTO ETE VALUES(?,?,?,?,?,?,?)");
            ps.setString(1, id);
            ps.setString(2, name);
            ps.setString(3, opt1);
            ps.setString(4, opt2);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ETEAddQue.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
