 ...
 * @author suyog
 */
public class PythonExamPage extends javax.swing.JFrame {
...
public void question()
{
        try{
         Connection conn = DatabaseConnection.connection();
         Statement stmt = conn.createStatement();
         ResultSet rs1 = stmt.executeQuery("SELECT * FROM PYTHON WHERE id = '"+questionId+"'");
         while(rs1.next())
         {
...
public void submit()
{
 ...
 try{
     Connection conn = DatabaseConnection.connection();
     Statement stmt = conn.createStatement();
     stmt.executeUpdate("UPDATE SAMPLE1 SET python = '"+marks+"' WHERE Enrollment_No = '"+EnrollmentNo+"'");
     String marks1 = String.valueOf(marks);
...
Timer time;
    PythonExamPage(int EnrollmentNo) {
        initComponents();
        jRadioButton5.setVisible(false);
    ...
    /**
     * Creates new form PythonExamPage
     */
    public PythonExamPage() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jPanel1.add(jRadioButton5, new org.netbeans.lib.awtextra.AbsoluteConstraints(520, 550, -1, -1));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PythonExamPage.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new PythonExamPage().setVisible(true);
            }
        });
    }
