 ...
 * @author suyog
 */
public class ETEExamPage extends javax.swing.JFrame {
...
public void question()
{
        try{
         Connection conn = DatabaseConnection.connection();
         Statement stmt = conn.createStatement();
         ResultSet rs1 = stmt.executeQuery("SELECT * FROM ETE WHERE id = '"+questionId+"'");
         while(rs1.next())
         {
...
public void submit()
{
 ...
 try{
     Connection conn = DatabaseConnection.connection();
     Statement stmt = conn.createStatement();
     stmt.executeUpdate("UPDATE SAMPLE1 SET ete = '"+marks+"' WHERE Enrollment_No = '"+EnrollmentNo+"'");
     String marks1 = String.valueOf(marks);
...
Timer time;
    ...
    /**
     * Creates new form ETEExamPage
     */
    public ETEExamPage() {
        initComponents();
    }

    ETEExamPage(int EnrollmentNo) {
        initComponents();
        jRadioButton5.setVisible(false);
    ...
    private void initComponents() {
        ...
        jPanel1.add(jRadioButton5, new org.netbeans.lib.awtextra.AbsoluteConstraints(590, 550, -1, -1));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ETEExamPage.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ETEExamPage().setVisible(true);
            }
        });
    }
